...
import me.kickscar.mysite.exception.GlobalExceptionHandler;
...
public class FileUploadService {
	...
	private static final String SAVE_PATH = "/Users/kickscar/uploads-mysite";
	...
	public String restore(MultipartFile file) {
		...
		try {
			...
			File fileDirectory = new File(SAVE_PATH);
